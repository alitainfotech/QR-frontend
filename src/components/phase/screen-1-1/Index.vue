  ...
  <div>
    ...
    <div class="contentHeight">
      <div class="pl-5 pr-5 pb-4">
        <p class="text-primary text-capitalize text-center text-18-medium mb-2 py-1">Awaiting Arrival</p>
        <ProductCombination>
        ...
        <ProductCombination>
          <template v-slot:product>
            <BaseCheckBox
              id="checkbox3"
              label="Trousers | 220551"
              value="Trousers | 220551"
              color="#FFEBF8"
              borderColor="#F9DAEE"
            />
          </template>
        ...
        <ProductCombination>
          <template v-slot:product>
            <BaseCheckBox
              id="checkbox4"
              label="Waistcoat | 130200"
              value="Waistcoat | 130200"
              color="#E3BADB"
              borderColor="#CE86C0"
            />
          </template>
      ...
      <StorageCard>
        <template v-slot:title>
          <div class="text-primary text-capitalize">Currently In-Storage</div>
        </template>
        <template v-slot:productCombination>
          <ProductCombination>
            <template v-slot:product>
              <BaseCheckBox
                id="checkbox1"
                label="Jacket | 1356681"
                value="Jacket | 1356681"
                color="#D9D9D9"
                borderColor="#CBCACA"
                checked="true"
              />
...
import StorageCard from "../common/StorageCard.vue";
</script>